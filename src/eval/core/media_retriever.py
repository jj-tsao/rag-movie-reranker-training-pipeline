...
class MediaRetriever:
    ...
    def _query_dense(self, vector, media_type, qdrant_filter, semantic_retrieval_limit=300):
        collection = (
    ...
    def _query_sparse(self, vector, media_type, qdrant_filter, bm25_retrieval_limit=20):
        collection = (
            self.movie_collection_name
            if media_type == "movie"
            else self.tv_collection_name
