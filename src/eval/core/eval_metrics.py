...
# Usage:
# heldout = [{"query":"...", "positive":"..."}, ...]
# preds_final = {"query": ["title1", "title2", ...], ...}
# preds_meta  = {"query": ["title1", "title2", ...], ...}
# df_final = evaluate_system(heldout, preds_final)
# df_meta  = evaluate_system(heldout, preds_meta)
# print(summarize(df_final)); print(summarize(df_meta))
# print(paired_bootstrap(df_final, df_meta, "NDCG@10"))
