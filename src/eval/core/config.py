...
SAMPLE_PATH = Path(__file__).resolve().parent.parent / "data" / "reranker_train_36k_weighted-negative_0806.jsonl"
VAL_IDX_PATH = Path(__file__).resolve().parent.parent / "data" / "val_indices.pt"
